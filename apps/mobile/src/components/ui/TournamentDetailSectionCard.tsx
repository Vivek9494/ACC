  ...
  return (
    <Card className="rounded-control p-4">
      <View className="mb-3 flex-row items-center gap-2">
        {icon}
        <Text variant="cardTitle" className="min-w-0 flex-1 font-sans-bold text-primary">
          {title}
        </Text>
...
export function TournamentDetailInfoRow({
  ...
  return (
    <View className="gap-1">
      ...
      <Text variant="body" className="font-sans-semibold text-on-surface" numberOfLines={0}>
        {value}
      </Text>
    </View>
  );
